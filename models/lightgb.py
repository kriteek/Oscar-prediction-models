...
winner_df[['movie_id', 'category', 'year_ceremony', 'actual', 'predicted', 'probability']].to_csv("predicted_oscar_winners_lgbm.csv", index=False)
print("\n🏆 Predicted winners saved to predicted_oscar_winners_lgbm.csv")
